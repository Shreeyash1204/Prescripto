...
const RealtedDoctors = ({speciality,docId}) => {
    ...
    if (doctors.length > 0 && speciality) {
        ...
        console.log('Filtered related doctors:', doctorsData);
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Sinply browse through our extensive list of trusted doctors</p>
