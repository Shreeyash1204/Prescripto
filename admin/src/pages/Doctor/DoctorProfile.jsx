  ...
  return profileData &&  (
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div>
          <p className='flex items-center gap-1 text-sm font-medium text-nuetral-800 mt-3'>About</p>
        ...
        <div className='flex gap-1 pt-2'>
          <input onChange={()=>isEdit && setProfileData(prev => ({...prev,available:!prev.available}))} className='accent-blue-700' checked={profileData.available} type="checkbox" id="" />
